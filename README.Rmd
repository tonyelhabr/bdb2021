...
3.  Perform analyses of targeted picks plays and individual coverage of targeted receivers using (1) a Frequentist approach, (2) a causal approach, and a more traditional machine learning approach.
...
The robustness of a causal approach that attempts to account for multiple backdoor pathways given a final response variable that is non-linear (EPA) is a little suspect to me, hence why I now resort to treating this as a "traditional" machine learning problem.[^8](While%20I%20deemed%20regression%20with%20appropriate%20interactions%20sufficient%20for%20modeling%20the%20non-linear%20nature%20of%20EPA,%20I%20think%20it%20becomes%20overwhelming%20in%20this%20case,%20so%20I've%20resorted%20to%20a%20non-linear%20modeling%20framework.)
