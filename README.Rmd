...
All code is available in [this GitHub repo](https://github.com/tonyelhabr/bdb2021). One can `remotes::install_packages('tonyelhabr/bdb2021')` and run [this script](https://github.com/tonyelhabr/bdb2021/blob/master/data-raw/99_analyze_treatments.R) to reproduce all figures.
