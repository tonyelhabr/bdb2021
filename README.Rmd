...
The table below provides some evidence for the success of pick plays relative to all other passing plays, in terms of expected points added (EPA).

![](https://github.com/tonyelhabr/bdb2021-data/raw/master/figs/t_test_simple.png)
